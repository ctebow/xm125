 ...
 *
 * Copied from `dual_xm125_sketch/ConfigHelpers.ino` so the new sketch
 * uses the same configuration conventions before triggering IQ captures.
 */
...
const uint32_t SIGNAL_QUALITY = 35000; // factor-of-1000 from the exp tool
